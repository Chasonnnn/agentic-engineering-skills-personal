...
| [dependency-modernization](dependency-modernization/SKILL.md) | Upgrade dependencies with official release review, local feature adoption, compatibility checks, and measured validation. |
